...
<?php session_start(); 
//succession shi ma win khwint pay
    if (!isset($_SESSION['login_user'])) {
        header("location:frontend/login.php");
    }


    //login user ka admin role phyit ma backend hte loh ya 
    if (isset($_SESSION['login_user'])) {
        ...
        <aside class="app-sidebar">
            <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="https://s3.amazonaws.com/uifaces/faces/twitter/jsa/48.jpg" alt="User Image">
                <div>
                  ...
                  <p class="app-sidebar__user-designation"><?$_SESSION['login_user']['role_name']; ?></p>
                </div>
            </div>
            ...
            <ul class="app-menu">
                ...
                <li>
                    <a class="app-menu__item" href="dishboard.php">
                ...
                <li>
                    <a class="app-menu__item" href="frontend/index.php">
