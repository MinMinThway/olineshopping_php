			          	...
			          	<li class="dropdown-submenu">
				            ...
				            <ul class="dropdown-menu">
				            	...
				            	?>
				              	...
				              	<li><a class="dropdown-item" href="subcategory_data.php?id=<?= $subid ?>"><?=$subname ?></a></li>
			...
			<div class="col-3">
				<div class="hov-dropdown d-inline-block">
          			...
          			<div class="dropdown-menu" aria-labelledby="navbarDropdown2">
          				...
          				?>
            			<a class="dropdown-item" href="brand.php?id=<?=$id ?>"><?=$name ?></a>
            			<div class="dropdown-divider"></div>
            			<?php  } ?>
          			</div>
        		</div>
	...
	<div id="mySidebar" class="sidebar">
		...
		<div class="mt-3">
			...
			<div class="collapse sidebardropdown_container_category mt-3" id="category<?=$id ?>">
				...
				?>
			    <a href="subcategory_data.php?id=<?= $subid ?>" class="py-2"><?=$subname ?></a>
			    <?php } ?>
			</div>
